...
<body>
    ...
    <form action="ConfirmarV.php" method="post">
        ...
        <input class="ocultar" type="hidden" value="<?php echo $idproducto?> " name="idproducto">
        <input class="ocultar" type="text" value="<?php echo $nombre?>" name="nombrepr" readonly><br><br>
        <label for="">Precio por Producto: $</label>
        <input class="ocultar" type="text" value="<?php echo $precio?>" name="precio" readonly><br><br>
        <label for="">Productos disponibles:</label>
        <input class="ocultar" type="text" value="<?php echo $productotal?>" name="total" readonly><br><br>
